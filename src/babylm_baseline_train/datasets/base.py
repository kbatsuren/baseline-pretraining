...
class BaseGroupDataset(ABC):
    def __init__(self, seq_len, tokenizer):
        ...
        replaces = dict()
        indx = -1
        with open(TOKEN_SAVE_FOLDER+'/roberta.all.replacements.v2.tsv', encoding='utf-8') as f:
          for line in f:
            indx+=1
            if indx == 0:
              continue
    ...
    def tokenize_function(self, examples):
        ...
        f_token = open(TOKEN_SAVE_FOLDER+"replace.records.roberta-base.tsv", "a", encoding = "utf-8")
        indd = 0
